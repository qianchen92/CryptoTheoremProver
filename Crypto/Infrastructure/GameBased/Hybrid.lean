...
def ofList
    (firstGame : Crypto.Infrastructure.Computation.Game Outcome)
    (games : List (Crypto.Infrastructure.Computation.Game Outcome)) :
...
def Stepwise
    ...
    (relation :
      Crypto.Infrastructure.Computation.Game Outcome →
        Crypto.Infrastructure.Computation.Game Outcome → Prop) : Prop :=
...
theorem ofList_stepwise_iff_isChain
    ...
    (relation :
      Crypto.Infrastructure.Computation.Game Outcome →
        Crypto.Infrastructure.Computation.Game Outcome → Prop) :
...
theorem ofList_stepIndistinguishable_iff
    (firstGame : Crypto.Infrastructure.Computation.Game Bool)
    (games : List (Crypto.Infrastructure.Computation.Game Bool)) :
