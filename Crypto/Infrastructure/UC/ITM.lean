...
structure ITMFamily
  ...
  State : Crypto.SecPar → Address → Type uState
  Leakage : Crypto.SecPar → Address → Type uLeakage
  Erasure : Crypto.SecPar → Address → Type uErasure
  Output : Crypto.SecPar → Address → Type uOutput
