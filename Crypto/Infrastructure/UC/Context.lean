...
structure KernelSimulation
    ...
    (outerNetwork : (sec : Crypto.SecPar) → NetworkAdapter outerFamily sec)
    (outerInitial : (sec : Crypto.SecPar) →
    ...
    (innerNetwork : (sec : Crypto.SecPar) → NetworkAdapter innerFamily sec)
    (innerInitial : (sec : Crypto.SecPar) →
...
noncomputable def comp
    ...
    {middleNetwork : (sec : Crypto.SecPar) → NetworkAdapter middleFamily sec}
    {middleInitial : (sec : Crypto.SecPar) →
