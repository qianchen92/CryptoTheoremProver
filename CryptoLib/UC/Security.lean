...
open CryptoLib.Core.Infrastructure.GameBased
...
abbrev PPTAddressedITMAdmissible
    ...
    (runtime : CryptoLib.Core.SecPar → Nat) : Prop :=
  CryptoLib.Core.Infrastructure.Complexity.OperationalRealization machine runtime
...
structure PPTAddressedITMCertificate
  ...
  initBudget : CryptoLib.Core.SecPar → LocalAddress → M.Cost
  activationBudget : CryptoLib.Core.SecPar → LocalAddress → M.Cost
  erasureBudget : CryptoLib.Core.SecPar → LocalAddress → M.Cost
  leakageBudget : CryptoLib.Core.SecPar → LocalAddress → M.Cost
