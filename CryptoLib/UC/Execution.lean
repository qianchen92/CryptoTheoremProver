...
structure CertifiedRealWorld
  ...
  certificate :
    PPTExecutionCertificate
      ...
      measure world.kernelCost world.networkAdapter world.initial
...
noncomputable def realFuelCertificate
    ...
    FuelCertificate
      ...
      pair.real.world.kernelCost pair.real.world.networkAdapter
...
noncomputable def idealFuelCertificate
    ...
    FuelCertificate
      ...
      pair.ideal.world.kernelCost pair.ideal.world.networkAdapter
