...
theorem oneTimeEncryptionOracle_false_eq_true
    (F : Family M) (sec : CryptoLib.Core.SecPar) (pp : PublicParam M) :
...
theorem oneTimeAdvantage_eq_zero
  ...
  funext sec
  simp [OneTimeAdvantage, CryptoLib.Core.Infrastructure.GameBased.Advantage,
    CryptoLib.Core.Infrastructure.GameBased.AcceptProb, oneTimeSecurityGame_false_eq_true F A]
