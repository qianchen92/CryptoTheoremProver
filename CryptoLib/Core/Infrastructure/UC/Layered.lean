...
namespace CryptoLib.Core.Infrastructure.UC.Layered
...
abbrev SystemAddress (Tag : Type uAddress) (params : Parameters) :=
  CryptoLib.Core.Infrastructure.UC.Address Tag (Role params)
...
abbrev PartyAddress (Tag : Type uAddress) (params : Parameters) : Type uAddress :=
  CryptoLib.Core.Infrastructure.UC.Address Tag (PartyId params)
...
abbrev BoundaryAddress (Tag : Type uAddress) : Type uAddress :=
  CryptoLib.Core.Infrastructure.UC.Address Tag BoundaryRole
...
end CryptoLib.Core.Infrastructure.UC.Layered
