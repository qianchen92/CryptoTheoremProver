...
abbrev MathematicalParam (Scalar : Type uScalar) (Carrier : Type uGroup) :=
  CryptoLib.Core.Assumption.DL.Parameter.DecisionalCyclicAction Scalar Carrier
...
scoped[DDHParameter] attribute [instance]
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instAddGroup
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instFintypeCarrier
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instNonemptyCarrier
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instFintypeScalar
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instSMul
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instCommMonoidScalar
  CryptoLib.Core.Assumption.DL.DDH.PublicParam.instMulAction
...
scoped[DDHParameter] attribute [instance]
  CryptoLib.Core.Assumption.DL.DDH.instNonemptyScalar
...
theorem realSample_eq
  ...
  change PMF.map ULift.down
    (CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist
      ((realSampleProgram F).body sec)) = _
  simp only [realSampleProgram,
    CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist_bind,
    CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist_call_eq
      (familyAlgebraLaws F),
    CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist_pure,
    familyAlgebraLaws, algebraLaws,
...
theorem randomSample_eq
  ...
  change PMF.map ULift.down
    (CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist
      ((randomSampleProgram F).body sec)) = _
  simp only [randomSampleProgram,
    CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist_bind,
    CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist_call_eq
      (familyAlgebraLaws F),
    CryptoLib.Core.Infrastructure.Computation.Program.Code.valueDist_pure,
...
structure EfficiencyCertificate (F : Family M Parameter Scalar Carrier) where
  ...
  realSampleBudget : CryptoLib.Core.SecPar → M.Cost
  realSampleCostBound : Program.CostBound (realSampleProgram F) realSampleBudget
  randomSampleBudget : CryptoLib.Core.SecPar → M.Cost
