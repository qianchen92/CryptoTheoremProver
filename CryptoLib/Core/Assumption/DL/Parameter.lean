...
namespace CryptoLib.Core.Assumption.DL.Parameter
...
def toAdditiveGroupParam
    ...
    CryptoLib.Core.Infrastructure.Computation.Algebra.Parameter.AdditiveGroupParam where
  Carrier := Carrier
...
end CryptoLib.Core.Assumption.DL.Parameter
